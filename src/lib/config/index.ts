    ...
    tts: [
       {
         ...
         type: 'switch',
         required: false,
         description: 'Enable text-to-speech using an OpenAI-compatible API.',
         default: false,
         scope: 'server',
       },
       {
         name: 'Auto-narrate responses',
         key: 'autoNarrate',
         type: 'switch',
         required: false,
         description: 'Automatically start narrating when a response is generated.',
         default: false,
         scope: 'server',
       },
       {
         ...
         type: 'string',
         required: false,
         description: 'Spoken before each response. Leave empty to skip the intro.',
      ...
      },
      {
        ...
        type: 'password',
        required: false,
        description: 'Your API key for the TTS provider.',
        placeholder: 'sk-...',
        default: '',
        scope: 'server',
      },
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        description: 'The voice to use. Select a voice below or enter a custom voice ID.',
        placeholder: 'af_aoede',
        default: 'af_aoede',
        scope: 'server',
      },
    ],
